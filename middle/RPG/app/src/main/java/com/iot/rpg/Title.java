    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toAdventure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (readDB(id.getText().toString().trim(), pass.getText().toString().trim())) {
                    Toast.makeText(Title.this, "로그인 성공", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(Title.this, AdventureActivity.class);
                    startActivity(intent);
                }
                else{
                    Toast.makeText(Title.this, "로그인 실패", Toast.LENGTH_SHORT).show();
                    id.setText("");
                    pass.setText("");
                }
        ...
        enroll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(Title.this, "ID 또는 PASS 미입력. 다시 진행하세요", Toast.LENGTH_LONG).show();
                    enroll.setVisibility(INVISIBLE);
                } else if (checkID(id.getText().toString().trim())) {
                    Toast.makeText(Title.this, "중복된 ID", Toast.LENGTH_SHORT).show();
                    id.setText("");
                } else
                {
                    writeDB(id.getText().toString().trim(), pass.getText().toString().trim());
                    Toast.makeText(Title.this, "등록완료", Toast.LENGTH_SHORT).show();
                    enroll.setVisibility(INVISIBLE);
                }
            }
        });
        ...
        newMember.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                id.setText("");
                pass.setText("");
                Toast.makeText(Title.this, "등록할 ID,PASS 입력후 확인 클릭", Toast.LENGTH_LONG).show();
